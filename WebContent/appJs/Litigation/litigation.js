		...
		$.ajax({
			...
			success : function(result){
				...
				$.each(result,function(key,value){
					...
					data += "<td class='demo visi'>"+value['liti_type_name']+"</td>";
					data += "<td class='demo visi'>"+value['liti_case_filing_date']+"</td>";
					
					data += "<td >"+value['liti_next_hearing_date']+"</td>";
					data += "<td >"+value['liti_case_title']+"</td>";
					
					data += "<td class='demo visi'>"+value['liti_jurisdiction_name']+"</td>";
					data += "<td class='demo visi'>"+value['liti_external_counsel']+"</td>";
					
					data += "<td class='demo visi'>"+value['liti_intenal_person']+"</td>";
					
					data += "<td class='demo visi'>"+value['liti_advocate']+"</td>";
					data += "<td class='demo visi'>"+value['liti_advocate_law_firm_name']+"</td>";
					
					data += "<td class='demo visi'>"+value['liti_party_by']+"</td>";
					data += "<td class='demo visi'>"+value['liti_party_against']+"</td>";
					data += "<td class='demo visi'>"+value['liti_oppo_party_address']+"</td>";
					data += "<td class='demo visi'>"+value['liti_oppo_advo_law_firm']+"</td>";
					data += "<td class='demo visi'>"+value['liti_opposite_party_advocate']+"</td>";
					
					data += "<td class='demo visi'>"+value['liti_oppo_advo_contact']+"</td>";
					data += "<td class='demo visi'>"+value['liti_court']+"</td>";
					data += "<td class='demo visi'>"+value['liti_amount_involved']+"</td>";
					data += "<td class='demo visi'>"+value['liti_relevant_law']+"</td>";
					data += "<td class='demo visi'>"+value['liti_brief_description']+"</td>";
					
					
					data += "<td >"+value['liti_assigned_to']+"</td>"
					data += "<td >"+value['liti_secondary_responsible_name']+"</td>"
					data += "<td >"+value['liti_third_responsible_person_name']+"</td>"
					data += "<td >"+' Edited by '+value['liti_updated_by']+' Edited on '+value['liti_updated_at']+"</td>"
	...
	function addFileInput1() {
	   // if(filecount <=5){
		...
		.append(
				...
				+"<label class='col-sm-8 control-label'>Upload Document:</label>"
				+"<div class='col-sm-4'><input type='file' name='completion_documents' class='file-loading'/>"
				+"</div>"
