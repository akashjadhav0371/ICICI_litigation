...
<div class="page_container">
	...
	<div class="col-md-12">
		...
		<div class="col-md-1">
			<a href="./customisablelist" class="btn btn-primary">Customisable Listing</a>
		</div>
	</div>
			...
			<table id="LitigationList" class="table table-striped table-bordered"
				...
				<thead>
					<tr style="background: #a72f14; color: #fff;">
					    ...
					    <th class="demo visi">Advocate Name</th>
					    <!-- <th class="demo visi">Advocate Address</th>
					    <th class="demo visi">Advocate Contact Number</th>
					    <th class="demo visi">Advocate Email Id</th> -->
					    
						<th  class="demo visi">Advocate Law Firm</th>
				...
				<tbody id="searchResult">
					<c:forEach items="${list_litigation}" var="litigation">
						<tr id="row_${litigation.liti_id}">
							...
							<td  class="demo visi">${litigation.liti_advocate}</td>
							
							<%-- <td  class="demo visi">${litigation.advo_address}</td>
							<td  class="demo visi">${litigation.advo_mobile_no}</td>
							<td  class="demo visi">${litigation.advo_email_id}</td> --%>
							
							
							
						    <td  class="demo visi">${litigation.liti_advocate_law_firm_name}</td>
							...
							<td >${litigation.liti_litigation_result} /
							     ${litigation.liti_status_updated_at}
							</td>
			...
			success : function(response) {
				if(response.message=="success"){
					...
					//    bootbox.alert("Report Generated successfully."); 
					 ...
					 bootbox.alert("We have not found any record within these dates !");
				} 
			},
