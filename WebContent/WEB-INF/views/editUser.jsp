							...
							<div class="col-sm-9">
								<sf:select path="user_role_id" class="form-control" name="user_role_id">
								  <sf:option value="0">--Select--</sf:option>
							    	<sf:option value="1">Administrator(IT Department)</sf:option>
								<%-- <sf:option value="2">Normal User</sf:option> --%>
								<sf:option value="7">Executor</sf:option>
								<sf:option value="8">Evaluator</sf:option>
								<sf:option value="9">Legal Head</sf:option>
								<sf:option value="10">ID Creator</sf:option>
