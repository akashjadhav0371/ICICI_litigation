					...
					<div class="tab-pane fade active in" id="LitigationDetails"
						...
						<table id="example" class="table table-striped table-bordered"
							...
							<tr>
								...
								<td>${litigation_details_by_id.liti_employee_code }</td>
							</tr>
							<tr>
				...
				<div class="tab-pane fade active in" id="litigationcaseTab" style="padding: 10px;">
					...
					<div class="tab-pane fade" id="Completion" style="padding: 10px;">
						<div class="f_form_content">
							...
							<td><c:forEach items="${completionDocuments}" var="document" varStatus="doc">
							
							<a href="./downloadcompletionDoc?comp_doc_id=${document.comp_doc_id}">${document.comp_original_file_name}</a>
							...
							<td class="edit"><c:choose>
									<c:when
										...
										<a href="editCompletion?liti_id=${litigation_details_by_id.liti_id}"><button
