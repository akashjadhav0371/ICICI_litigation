...
<body>
	...
	<!--navbar-->
	<nav class="navbar navbar-inverse navbar-fixed-top"> <c:choose>
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<c:choose>
							<c:when
								...
								<li><a href="./showLitigationCalendar"><img
										class="menu" src="images/DashboardIcons/calender.png">Litigation
										Calendar</a></li>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									type="button" data-toggle="dropdown"><img class="menu"
										src="images/DashboardIcons/repository.png">Litigation
					...
					<ul class="dropdown-menu">
						...
						<c:choose>
							...
							<c:when
								test="${sessionScope.sess_user_role==1 || sessionScope.sess_user_role==5 || sessionScope.sess_user_role==7 || sessionScope.sess_user_role==8 || sessionScope.sess_user_role==9 || sessionScope.sess_user_role==10}">
							...
							<div class="col-md-4" id="slide">
								...
								<div class="row">
									<div class="col-md-12">
										<c:choose>
											<c:when
												test="${sessionScope.sess_user_role==1 || sessionScope.sess_user_role==5}">
												<div class="col-md-4">
													<div class="icon1">
														<a style="text-decoration: none;"
															href="./listOrganizations"><img
										...
										<c:choose>
											<c:when
												test="${sessionScope.sess_user_role==1 || sessionScope.sess_user_role==5 || sessionScope.sess_user_role==9}">
												...
												<div class="col-md-4">
													<div class="icon2">
														<a style="text-decoration: none;"
															...
															src="images/dash_board/UserEntityMapping.png"
