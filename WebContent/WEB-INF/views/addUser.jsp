					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select class="form-control" name="user_role_id"
								id="user_role_id">
								<option value=0>--Select--</option>
								<option value="1">Administrator(IT Department)</option>
								<!-- <option value="2">Normal User</option> -->
								<option value="7">Executor</option>
								<option value="8">Evaluator</option>
								<option value="9">Legal Head</option>
								<option value="10">ID Creator</option>
