...
import lcmt.domain.CompletionDocuments;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////			
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				litigationDetails.setLiti_case_reference_no(object[3].toString());
					...
					litigationDetails.setLiti_case_reference_no("NA");
				...
				litigationDetails.setLiti_amount_involved(object[10].toString());
					...
					litigationDetails.setLiti_amount_involved("NA");
				...
				litigationDetails.setLiti_brief_description(object[12].toString());
					...
					litigationDetails.setLiti_brief_description("NA");
				
				if (object[13] != null)
				litigationDetails.setLiti_status(object[13].toString());
				else
					litigationDetails.setLiti_status("NA");
				...
				litigationDetails.setLiti_client_liti_id(object[23].toString());
					...
					litigationDetails.setLiti_client_liti_id("NA");
				...
				litigationDetails.setLiti_criticality(object[27].toString());
					...
					litigationDetails.setLiti_criticality("NA");
				if (object[28] != null)
				...
				if (object[34] != null && object[34] != "0") {
					...
					litigationDetails.setLiti_previous_liti_ref_no("0");
				}
				...
				if (object[48] != null)
					litigationDetails.setLiti_employee_code(object[48].toString());
				else
					litigationDetails.setLiti_employee_code("NA");
	...
	public int saveHearingStage(HearingStage  hearingStage,  ArrayList<MultipartFile> hearing_doc,
		...
		try {
			...
			String case_title = litigationDao.getLitigationDetailsForAlert(hearingStage.getTtrn_litigation_id());
	...
	public int updateHearingStage(HearingStage hearingStage, ArrayList<MultipartFile> hearing_doc,
		...
		try {
			...
			String originalFileName = null;
			String generatedFileName = null;
			int lastGeneratedValueHearId = litigationDocumentsDao.getLastGeneratedValueByHearingStageId(hearingStage.getTtrn_hearing_stage());
			for (int i = 0; i < hearing_doc.size(); i++) {
				MultipartFile file = hearing_doc.get(i);
	...
	public void updateLitigation(Litigation litigation, String status, HttpSession session,
		...
		try {
			...
			litigation.setLiti_status_updated_at(OldLitigation.getLiti_status_updated_at());
			...
			litigation.setLiti_last_generated_value_for_client_liti_id(OldLitigation.getLiti_last_generated_value_for_client_liti_id());
	...
	public String searchLitigation(String json, HttpSession session) {
		try {
			String next_hearing_date = "";
			String liti_case_filing_date = "";
			
			String liti_updated_at = null;
			SimpleDateFormat sdfIn = new SimpleDateFormat("yyyy-MM-dd");
			SimpleDateFormat sdfOut = new SimpleDateFormat("dd-MM-yyyy");
			JSONArray sendList = new JSONArray();
			...
			while (iterator.hasNext()) {
				...
				jsonObject.put("liti_type_name", litigationDao.getLiti_typeById(litigation.getLiti_type_id()).getLiti_type_name());
			
				if (litigation.getLiti_case_filing_date()!= null) {
					liti_case_filing_date = litigation.getLiti_case_filing_date().toString();
				
				if (!liti_case_filing_date.equals(null)) {
				jsonObject.put("liti_case_filing_date", sdfOut.format(sdfIn.parse(liti_case_filing_date)));
				} else {
					jsonObject.put("liti_case_filing_date", "NA");
				}
			}
				
				jsonObject.put("liti_jurisdiction_name", litigation.getLiti_jurisdiction_name());
			  
		
					
				if (litigation.getLiti_external_counsel_id() != 0) {
				jsonObject.put("liti_external_counsel", externalCounselDao.getExte_CounById(litigation.getLiti_external_counsel_id()).getExte_coun_name());
				} else {
					jsonObject.put("liti_external_counsel", "NA");
				}
				
		
				jsonObject.put("liti_intenal_person", litigation.getLiti_intenal_person());
				
				if (litigation.getLiti_advocate_id() != 0) {
				jsonObject.put("liti_advocate", advocateDao.getAdvocateById(litigation.getLiti_advocate_id()).getAdvo_name());
				} else {
					jsonObject.put("liti_advocate", "NA");
				}
				
				if (litigation.getLiti_advocate_law_firm() != 0) {
				jsonObject.put("liti_advocate_law_firm_name", lawFirmDao.getLawFirmById(litigation.getLiti_advocate_law_firm()).getLawf_name());
				} else {
					jsonObject.put("liti_advocate_law_firm_name", "NA");
				}
				
				jsonObject.put("liti_party_by", litigation.getLiti_party_by());
				
				jsonObject.put("liti_party_against", litigation.getLiti_party_against());
				jsonObject.put("liti_oppo_party_address", litigation.getLiti_oppo_party_address());
				jsonObject.put("liti_oppo_advo_law_firm", litigation.getLiti_oppo_advo_law_firm());
				jsonObject.put("liti_opposite_party_advocate", litigation.getLiti_opposite_party_advocate());
				jsonObject.put("liti_oppo_advo_contact", litigation.getLiti_oppo_advo_contact());
				
				
				if (litigation.getLiti_court() != 0) {
				jsonObject.put("liti_court", courtDao.getCourtById(litigation.getLiti_court()).getCourt_name());
				} else {
					jsonObject.put("liti_court", "NA");
				}
				
				
				jsonObject.put("liti_amount_involved", litigation.getLiti_amount_involved());
				
				jsonObject.put("liti_relevant_law", litigation.getLiti_relevant_law());
				jsonObject.put("liti_brief_description", litigation.getLiti_brief_description());
				
				jsonObject.put("liti_secondary_responsible_name", userService.getUserFullNameById(litigation.getLiti_secondary_responsible()));
				jsonObject.put("liti_third_responsible_person_name", userService.getUserFullNameById(litigation.getLiti_third_responsible_person()));
				jsonObject.put("liti_updated_by",userService.getUserFullNameById(litigation.getLiti_updated_by()));
				
			if (litigation.getLiti_updated_at()!= null) {
					liti_updated_at = litigation.getLiti_updated_at().toString();
				
				if (!liti_updated_at.equals(null)) {
				jsonObject.put("liti_updated_at", sdfOut.format(sdfIn.parse(liti_updated_at)));
				} else {
					jsonObject.put("liti_updated_at", "NA");
				}
			}
	...
	@Override
	public void saveLitigationCompletion(Litigation litigation, ArrayList<MultipartFile> completion_documents) {
		try {
			...
			OldLitigation.setLiti_status_updated_at(utilitieservice.getCurrentDate());
			...
			String liti_case_title = OldLitigation.getLiti_case_title();
			String liti_case_reference_no = OldLitigation.getLiti_case_reference_no();
			...
			// Upload Documents - akash jadhav
			
			String originalFileName = null;
			String generatedFileName = null;
			
			int lastGeneratedValueForCompDoc = litigationDocumentsDao.getLastGeneratedValueByCompId(litigation_id);
			
			for (int i = 0; i < completion_documents.size(); i++) {
				MultipartFile file = completion_documents.get(i);
				
					if (file.getSize() > 0) {
						File dir = new File("C:" + File.separator + project_name + File.separator + "Documents"
								+ File.separator + "CompletionDocuments");
						if (!dir.exists())
							dir.mkdirs();

						lastGeneratedValueForCompDoc++;
						
						originalFileName = file.getOriginalFilename();
						generatedFileName = "uploadedCompDoc_" + litigation_id + "_" + lastGeneratedValueForCompDoc + "." + file.getOriginalFilename().split("\\.")[1];
						File newFile = new File(dir.getPath() + File.separator + generatedFileName);
						if (!newFile.exists()) {
							newFile.createNewFile();
						}
						...
						CompletionDocuments completionDocuments = new CompletionDocuments();

						completionDocuments.setComp_licences_id(litigation_id);
						completionDocuments.setComp_original_file_name(originalFileName);
						completionDocuments.setComp_generated_file_name(
								"C:/" + project_name + "/Documents/CompletionDocuments/" + generatedFileName);
						completionDocuments.setComp_last_generated_value_for_contract_id(lastGeneratedValueForCompDoc);
						completionDocuments.setComp_doc_added_by(utilitiesService.getCurrentSessionUserId(httpSession));
						completionDocuments.setComp_contract_created_date(utilitiesService.getCurrentDate());

						litigationDocumentsDao.saveCompletionDocuments(completionDocuments);
			...
			if (result != null) {
				...
				while (iterator.hasNext()) {
					...
					litigationReference.setLiti_case_reference_no(object[3].toString());
						...
						litigationReference.setLiti_case_reference_no("NA");
					if (object[2] != null)
					...
					litigationReference.setLiti_amount_involved(object[10].toString());
						...
						litigationReference.setLiti_amount_involved("NA");
					...
					litigationReference.setLiti_brief_description(object[12].toString());
						...
						litigationReference.setLiti_brief_description("NA");
					
					
					if (object[13] != null)
					litigationReference.setLiti_status(object[13].toString());
					else
						litigationReference.setLiti_status("NA");
					...
					litigationReference.setLiti_client_liti_id(object[23].toString());
						...
						litigationReference.setLiti_client_liti_id("NA");
					
					if (object[24] != null)
					litigationReference.setLiti_case_title(object[24].toString());
					else
						litigationReference.setLiti_case_title("NA");
					...
					if (Integer.parseInt(object[39].toString()) != 0) {
						litigationReference.setLiti_advocate(advocateService
								.getAdvocateById(Integer.parseInt(object[39].toString())).getAdvo_name());
					} else {
						litigationReference.setLiti_advocate("NA");
					}
					
					
					if (Integer.parseInt(object[40].toString()) != 0) {
						litigationReference.setLiti_advocate_law_firm_name(lawFirmService.getLawFirmById(Integer.parseInt(object[40].toString())).getLawf_name());
					} else {
						litigationReference.setLiti_advocate_law_firm_name("NA");
					}
					
					
					if (object[41] != null)
						litigationReference.setLiti_status_updated_at(sdfOut.format(sdfIn.parse(object[41].toString())));
	...
	public String acmLitigation(String json, HttpSession session) {
		...
		try {
			...
			style.setFont(font);
	     	...
	     	rowhead.createCell(0).setCellValue("Details");
			...
			for(int j = 0; j<=3; j++)
			  ...
			  List<Object> res = litigationDao.acmLitigation(json,session);
				...
				while (iterator.hasNext()) {
					...
					row7.createCell(0).setCellValue("Total Amount for the Company and cases adjudged remote for which no provisions are taken nor regarded as contingent liability ");
					if (objects[15] != null) 
					row7.createCell(1).setCellValue(objects[15].toString());
					if (objects[16] != null) 
					row7.createCell(2).setCellValue(objects[16].toString());
					if (objects[17] != null) 
					row7.createCell(3).setCellValue(objects[17].toString());
	...
	// Method Created : Akash Jadhav
		// Purpose : Get completion details to edit
		@Override
		public Litigation getCompletionDetailsById(int liti_id) {
			try {
				return litigationDao.getCompletionDetailsById(liti_id);
		...
		// Method Created :Akash Jadhav
		// Method purpose : Update completion contracts
		@Override
		public int updateCompletion(Litigation completion,ArrayList<MultipartFile> edit_completion_documents, HttpSession session) {
			try {

				Litigation updateCompletion = litigationDao.getLitigationByLitiId(completion.getLiti_id());
				
				if (updateCompletion != null) {
					
					updateCompletion.setLiti_litigation_result(completion.getLiti_litigation_result());
					updateCompletion.setLiti_disposal_date(completion.getLiti_disposal_date());
					updateCompletion.setLiti_synopsis_of_order(completion.getLiti_synopsis_of_order());
					updateCompletion.setLiti_comments(completion.getLiti_comments());
					updateCompletion.setLiti_id(completion.getLiti_id());
					updateCompletion.setLiti_last_date_for_filling_appeal(completion.getLiti_last_date_for_filling_appeal());
					updateCompletion.setLiti_completion_court_id(completion.getLiti_completion_court_id());
					updateCompletion.setFile_appeal_result(completion.getFile_appeal_result());
					
					updateCompletion.setLiti_status_updated_at(utilitieservice.getCurrentDateWithTime());
					
					litigationDao.updateLitigation(updateCompletion);
					
					
					// Upload Documents
					
					String litigation_id = "";
					litigation_id = String.valueOf(updateCompletion.getLiti_id());
					
					String originalFileName = null;
					String generatedFileName = null;
					
					int lastGeneratedValueForCompDoc = litigationDocumentsDao.getLastGeneratedValueByCompIdEdit(litigation_id);
					
					for (int i = 0; i < edit_completion_documents.size(); i++) {
						MultipartFile file = edit_completion_documents.get(i);
							...
							if (file.getSize() > 0) {
								...
								litigationDocumentsDao.saveCompletionDocumentsEdit(completionDocuments);
				...
				return updateCompletion.getLiti_id();
			} catch (Exception e) {
				e.printStackTrace();
			}
			return 0;
		...
		// Method Created : Akash Jadhav
				// Method purpose : get completion documents by id
				@Override
				public List<CompletionDocuments> getCompletionDocumentByLitiId(int l_id) {
					try {
						return litigationDao.getCompletionDocumentByLitiId(l_id);
					} catch (Exception e) {
						e.printStackTrace();
					}
					return null;
		...
		public void downloadcompletionDoc(int comp_doc_id, HttpServletResponse response) {
			try {
				if (litigationDao.getCompletionDocumentFilePath(comp_doc_id) != null) {

					File file = new File(litigationDao.getCompletionDocumentFilePath(comp_doc_id));
					InputStream is = new FileInputStream(file);
