		...
		try {
			...
			if (res != null) {
				...
				while (iterator.hasNext()) {
				    ...
				    String liti_party_by = objects[6].toString();
				    String liti_party_against = objects[13].toString();
				    String liti_case_title = objects[14].toString();
