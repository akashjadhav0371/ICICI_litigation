...
public class Litigation {
	...
	private Date liti_status_updated_at;
	...
	public Date getLiti_status_updated_at() {
		return liti_status_updated_at;
	}
	public void setLiti_status_updated_at(Date liti_status_updated_at) {
	...
	public int getLiti_court() {
		return liti_court;
	}
	public void setLiti_court(int liti_court) {
