...
public class LitigationReference {
	...
	private String liti_advocate;
	
	private int liti_advocate_law_firm;
	private String liti_advocate_law_firm_name;
	
	private String liti_employee_code;
	
	private String liti_status_updated_at;
	
	
	
	public String getLiti_status_updated_at() {
		return liti_status_updated_at;
	}
	public void setLiti_status_updated_at(String liti_status_updated_at) {
		this.liti_status_updated_at = liti_status_updated_at;
	}
	public String getLiti_employee_code() {
		return liti_employee_code;
	}
	public void setLiti_employee_code(String liti_employee_code) {
		this.liti_employee_code = liti_employee_code;
	}
	public String getLiti_advocate_law_firm_name() {
		return liti_advocate_law_firm_name;
	}
	public void setLiti_advocate_law_firm_name(String liti_advocate_law_firm_name) {
		this.liti_advocate_law_firm_name = liti_advocate_law_firm_name;
	}
	...
	public String getLiti_advocate() {
		return liti_advocate;
	}
	public void setLiti_advocate(String liti_advocate) {
		this.liti_advocate = liti_advocate;
	}
