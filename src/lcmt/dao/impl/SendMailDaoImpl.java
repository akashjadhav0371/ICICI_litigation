...
public class SendMailDaoImpl implements SendMailDao {
	...
	public List<Object> getLitigationDetailsByLitigationId(int liti_id) {
		try {
			String sql = "SELECT liti_id,liti_against_by_id,liti_type_name,liti_case_reference_no,liti_case_filing_date,liti_external_counsel_id,liti_party_by,liti_court, court_name , liti_amount_involved , liti_brief_description,liti_status,liti_client_liti_id,liti_party_against,liti_case_title "
