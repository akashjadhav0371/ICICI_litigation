...
public class UserDaoImpl implements UserDao {
	...
	private @Value("#{ldapconfig['serviceuserpassword'] ?: 'null'}") String serviceuserpassword;
	private @Value("#{ldapconfig['identifying_attribute'] ?: 'null'}") String identifying_attribute;
	private @Value("#{ldapconfig['userbase'] ?: 'null'}") String userbase;
	...
	public String authenticateUser(String username, String password, HttpSession session) {
		try {
			...
			/*
			 * String sqlNew = "SELECT * FROM mst_user where user_username =  '" + username
