...
public interface LitigationDocumentsDao {
	...
	public int getLastGeneratedValueByCompId(Object completion_stage_Id);
	public void saveCompletionDocuments(CompletionDocuments documents);
	
	public int getLastGeneratedValueByCompIdEdit(Object completion_stage_Id);
	public void saveCompletionDocumentsEdit(CompletionDocuments documents);
