	...
	public String getSupportQuery(@RequestParam("Cname") String Cname,
		...
		//	props.put("mail.smtp.starttls.enable", "true");
			...
			try {
				...
				message.setRecipients(Message.RecipientType.CC,InternetAddress.parse("akash.jadhav@lexcareglobal.com"));
				message.setSubject("Query raised from Litigation tool");
