				...
				for (int i = 0; i < assignId.size(); i++) {
					...
					while (iterator2.hasNext()) {
						...
						String liti_id = objects[10].toString();
						  ...
						  String liti_case_title = objects[11].toString(); 
						  String liti_case_reference_no = objects[12].toString();
			...
			if (assignId != null) {
				for (int i = 0; i < assignId.size(); i++) {
					...
					while (iterator2.hasNext()) {
						...
						String liti_case_reference_no = objects[14].toString();
